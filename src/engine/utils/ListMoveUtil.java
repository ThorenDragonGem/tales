...
public class ListMoveUtil
{
	...
	public static <T> void moveElementTo(List<T> list, T elementToMove, T targetElement, Position pos)
	{
		...
		// if the element to move is after the targetelement in the list, just
		// remove it
		// else the element to move is before the targetelement. When we removed
		// it, the targetindex should be decreased by one
